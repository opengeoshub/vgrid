...
def poly_to_grid(isea3h_dggs, resolution, geometry, feature_properties, compact):
    if platform.system() == "Windows":
        ...
        if geometry.geom_type == "LineString" or geometry.geom_type == "Polygon":
            ...
            or geometry.geom_type == "MultiPolygon"
        ):
            polys = list(geometry)
        ...
        if feature["geometry"]["type"] in ["Point", "MultiPoint"]:
            ...
            if feature["geometry"]["type"] == "Point":
                ...
                point_features = point_to_grid(
                    isea3h_dggs, resolution, point, feature_properties
                )
            ...
            if feature["geometry"]["type"] == "LineString":
                ...
                polyline_features = poly_to_grid(
                    isea3h_dggs, resolution, polyline, feature_properties, compact
                )
            ...
            if feature["geometry"]["type"] == "Polygon":
                ...
                polygon_features = poly_to_grid(
                    isea3h_dggs, resolution, polygon, feature_properties, compact
                )
...
def geojson2isea3h_cli():
    ...
    parser = argparse.ArgumentParser(
        description="Convert GeoJSON to Open-Eaggr ISEA3H DGGS"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-compact", action="store_true", help="Enable ISEA3H compact mode"
    )
