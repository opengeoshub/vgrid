        ...
        if feature["geometry"]["type"] in ["Point", "MultiPoint"]:
            ...
            if feature["geometry"]["type"] == "Point":
                ...
                point_features = point_to_grid(
                    isea4t_dggs, resolution, point, feature_properties
                )
            ...
            if feature["geometry"]["type"] == "LineString":
                ...
                polyline_features = poly_to_grid(
                    isea4t_dggs, resolution, polyline, feature_properties
                )
            ...
            if feature["geometry"]["type"] == "Polygon":
                ...
                polygon_features = poly_to_grid(
                    isea4t_dggs, resolution, polygon, feature_properties, compact
                )
...
def geojson2isea4t_cli():
    ...
    parser = argparse.ArgumentParser(
        description="Convert GeoJSON to Open-Eaggr ISEA4T DGGS"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-compact",
        action="store_true",
        help="Enable ISEA4T compact mode - for polygon only",
    )
