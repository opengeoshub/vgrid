        ...
        if feature["geometry"]["type"] in ["Point", "MultiPoint"]:
            ...
            if feature["geometry"]["type"] == "Point":
                ...
                point_features = point_to_grid(
                    rhealpix_dggs, resolution, point, feature_properties
                )
            ...
            if feature["geometry"]["type"] == "LineString":
                ...
                polyline_features = poly_to_grid(
                    rhealpix_dggs, resolution, polyline, feature_properties
                )
            ...
            if feature["geometry"]["type"] == "Polygon":
                ...
                polygon_features = poly_to_grid(
                    rhealpix_dggs, resolution, polygon, feature_properties, compact
                )
...
def geojson2rhealpix_cli():
    ...
    try:
        ...
        if args.compact:
            geojson_path = (
                f"{geojson_name}2rhealpix_{args.resolution}_compacted.geojson"
            )
